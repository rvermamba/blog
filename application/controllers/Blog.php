...
class Blog extends CI_Controller {
  ...
  public function viewBlog()
  {
    ...
    $config['base_url'] = base_url('user/viewBlog');
    $config['per_page'] = 4;
...
////////////
            ...
            $config['num_tag_close'] = '</li>';
                ...
                // $config['first_tag_open'] = '<li class="tm-paging-item">';
                // $config['first_tag_close'] = '</li>';
                // $config['last_tag_open'] = '<li class="tm-paging-item">';
                // $config['last_tag_close'] = '</li>';
                ...
                // $config['prev_tag_open'] = '<li class="tm-paging-item"><i class="fa fa-long-arrow-left"></i>';
                // $config['prev_tag_close'] = '</li>';
/////
