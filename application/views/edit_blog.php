                       ...
                       <div class="page-body">
                        <div class="row">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-5">
                               <input type="text" name='blog_title' value="<?php echo $blogdetails->blog_title ?>" id='blog_title' class="form-control">
                           </div>
                       </div> 
                       <div class="form-group row">
                              <label class="col-sm-2 col-form-label">Blog Description</label>
                              <div class="col-sm-5">
                               <input type="text" name='blog_description' value="<?php echo $blogdetails->blog_description ?>" id='blog_description' class="form-control">
                           </div>
                       </div>
                   </div>
